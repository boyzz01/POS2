...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow group flex flex-col"
     x-data="{
         ...
         dec() {
             if (this.qty > 0) { this.qty--; this.capped = false; this.schedule(); }
         },
    ...
    <div class="p-4 flex flex-col flex-1">
        ...
        <div class="mt-auto">
            ...
            @if(!$inStock)
                <button disabled
                        class="w-full mt-3 py-2 text-sm font-medium rounded-lg bg-gray-100 text-gray-400 cursor-not-allowed">
                    Habis
                </button>
            @else
                ...
                <div class="mt-3">
                    ...
                    <p x-show="capped" x-transition
                       class="text-xs text-amber-600 mt-1.5 text-center font-medium">
